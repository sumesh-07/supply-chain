    ...
    <div className="wrapper">
      <div className="row top-wrapper">
        ...
        <div className="col-12 col-md-8 tw-right">
          ...
          <Rating rating={Number(product.item["rating"]) / 20} editable={false}/>
         ...
         {new Date(Number(product.item["launchDate"]) * 1000).toDateString()}
          <br/>
          ...
          <div className='col-12 col-md-6'>
            ...
            {product.reviews.map(review => (
              <div className='my-1 border'> 
                ...
                <br/>
                Reviewed on: {new Date(Number(review["date"]) * 1000).toDateString()}
                <br/>
                {review["comment"]}
              </div>
            ))}
